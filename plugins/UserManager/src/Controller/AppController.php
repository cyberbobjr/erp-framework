<?php
    ...
    {
        protected $_registerRedirect = ['plugin'     => 'SubscriptionManager',
                                        'controller' => 'offers',
                                        'action'     => 'step1'];
        ...
        public function initialize()
        {
            ...
            $this->loadComponent('Auth', ['flash'                => ['element' => 'default'],
                                          ...
                                          'loginRedirect'        => ['controller' => 'Dashboards',
                                                                     'action'     => 'index',
                                                                     'plugin'     => NULL],
                                          'loginAction'          => ['plugin'     => $this->plugin,
                                                                     'controller' => 'users',
                                                                     'action'     => 'login'],
                                          'logoutRedirect'       => ['plugin'     => $this->plugin,
                                                                     'controller' => 'users',
                                                                     'action'     => 'login'],
                                          'sessionKey'           => 'User']);
