    ...
    class UpdateController extends AppController
    {
        ...
        public function index()
        {
            if (file_exists(ROOT . DS . 'update.lock')) {
                throw new \Cake\Http\Exception\ForbiddenException(__('L\'installation a déjà été paramétrée, supprimez le fichier install.lock pour recommencer l\'installation.'));
            }
