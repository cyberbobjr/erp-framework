<?php
    ...
    class InstallController extends AppController
    {
        public function beforeFilter(EventInterface $event)
        {
            ...
            $this->Authentication->allowUnauthenticated(['step']);
        }
...
// étape 3 : Validation et enregistrement
        ...
        private function _goToStep($step)
        {
            switch ($step) {
                case 1 :
        ...
        private function checkPassword($step)
        {
        ...
        private function _createAdminAccount()
        {
            ...
            $groupestable = FactoryLocator::get('Table')
                                          ->get('UserManager.Groupes');
            $userstable = FactoryLocator::get('Table')
                                        ->get('UserManager.Users');
            $groupe = $groupestable->findOrCreate(
                ['label' => 'ADMIN'],
        ...
        private function _configureDatasource(): void
        {
            ...
            $bdd['className'] = Connection::class;
            $bdd['driver'] = Mysql::class;
