...
<table width="100%">
    ...
    <tr>
        <td>
            <?= $operation->societe->raison_sociale ?>
            <br/>
            <?= $operation->societe->adresse1 ?><br/>
            <?= $operation->societe->code_postal . ' ' . $operation->societe->ville ?>
        </td>
        <td width="10%"
...
<table width="100%">
    ...
    <tfoot>
    <tr>
        <td class="totals" colspan="<?= ($operation->tier->tva) ? 4 : 2 ?>"><?= __('Total € TTC à régler') ?></td>
        <td align="right" class="totals" align="right"><?= number_format($operation->total_ttc, 2, ",", " ") ?>€</td>
    </tr>
    </tfoot>
</table>
