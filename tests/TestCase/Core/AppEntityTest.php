<?php
     ...
     */
    class AppEntityTest extends \Cake\TestSuite\TestCase
    {
        private $entityTest;
        private $vatsTable;
        public $fixtures = ['app.Vats'];
        /**
         * setUp method
         *
         * @return void
        ...
        {
            parent::setUp();
            $this->entityTest = new \App\Model\Entity\Vat();
            $this->vatsTable = \Cake\ORM\TableRegistry::getTableLocator()->get('Vats');
        }
        /**
         * tearDown method
         *
        ...
        public function test_should_return_all_columns()
        {
            ...
            self::assertArraySubset(['id', 'rate'], $vatfields->columns());
        }
